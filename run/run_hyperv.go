...
import (
	...
	"github.com/michaelhenkel/ckube/hyperv"
...
func runHyperV(args []string) {
	...
	err = hyperv.HypervStartConsole(*vmName)
	if err != nil {
		log.Infof("Console returned: %v\n", err)
	}
	hyperv.HypervRestoreConsole()
